...
return [
     ...
     *      /.htaccess
     *      /webroot/.htaccess
     *   And unbooking the baseUrl key below.
    ...
    'Datasources' => [
        'default' => [
             ...
             * MySQL on MAMP uses port 8889, MAMP users will want to unbooking
            ...
            /*
             * During development, if using MySQL < 5.6, unbookinging the
