...
<div class="bookings view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            ...
            <td><?= $booking->has('flight') ? $this->Html->link($booking->flight->title, ['controller' => 'Flights', 'action' => 'view', $booking->flight->id]) : '' ?></td>
        </tr>
        <tr>
    ...
    <div class="row">
        <h4><?= __('Booking') ?></h4>
        <?= $this->Text->autoParagraph(h($booking->booking)); ?>
    </div>
</div>
