...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'path' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'booking' => '', 'precision' => null, 'fixed' => null],
        ...
        'status' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'booking' => '1 = Active, 0 = Inactive', 'precision' => null],
        '_constraints' => [
